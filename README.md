...
The codebase provides a reusable implementation of bin‑aware counterfactual simulation operators, together with the complete workflow for reproducing all figures, tables, and results reported in the manuscript.
